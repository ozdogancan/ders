...
List<_DiscoveryCard> _buildFullPool() {
  return const [
    _DiscoveryCard(
      id: 'japandi_salon',
      title: 'Japandi Salon',
      subtitle: 'Sakin, acik ahsapli ve nefes alan bir yasam alani.',
      imageUrl:
      ...
      budget: 'mid',
      budgetLabel: '30-70K',
      colors: ['Kirik beyaz', 'Acik ahsap', 'Tas beji'],
    ...
    _DiscoveryCard(
      id: 'minimal_bedroom',
      title: 'Minimal Yatak Odasi',
      subtitle: 'Az esya, yumusak isik ve temiz cizgiler.',
      imageUrl:
          'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?auto=format&fit=crop&w=900&q=85',
      style: 'minimalist',
      styleLabel: 'Minimalist',
      room: 'yatak_odasi',
      roomLabel: 'Yatak Odasi',
      budget: 'mid',
      budgetLabel: '30-70K',
      colors: ['Beyaz', 'Kum beji', 'Yumusak gri'],
    ...
    _DiscoveryCard(
      id: 'boho_bedroom',
      title: 'Boho Kose',
      subtitle: 'Katmanli tekstiller ve sicak, rahat bir his.',
      imageUrl:
      ...
      budget: 'low',
      budgetLabel: '10-30K',
      colors: ['Terracotta', 'Keten', 'Adacayi'],
    ...
    _DiscoveryCard(
      id: 'modern_kitchen',
      title: 'Modern Mutfak',
      subtitle: 'Net hatlar, mat yuzeyler ve guclu kontrast.',
      imageUrl:
      ...
      budget: 'high',
      budgetLabel: '70-150K',
      colors: ['Antrasit', 'Sicak gri', 'Beyaz'],
    ...
    _DiscoveryCard(
      id: 'scandi_living',
      title: 'Iskandinav Aydinlik',
      subtitle: 'Ferahlik, dogal isik ve sicak sadelik.',
      imageUrl:
    ...
    _DiscoveryCard(
      ...
      title: 'Endustriyel Ofis',
      subtitle: 'Ham dokular, metal detaylar ve guclu karakter.',
      imageUrl:
          'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=900&q=85',
      style: 'industrial',
      styleLabel: 'Endustriyel',
      room: 'ofis',
      roomLabel: 'Ofis',
      budget: 'mid',
      budgetLabel: '30-70K',
      colors: ['Komur', 'Pas kahve', 'Beton'],
    ...
    _DiscoveryCard(
      id: 'classic_dining',
      title: 'Klasik Dokunush',
      subtitle: 'Dengeli, zamansiz ve biraz daha rafine.',
      imageUrl:
      ...
      budget: 'premium',
      budgetLabel: '150K+',
      colors: ['Fildisi', 'Ceviz', 'Altin beji'],
    ...
    _DiscoveryCard(
      id: 'luxury_bathroom',
      title: 'Luks Banyo',
      subtitle: 'Tas etkisi, yumusak aydinlatma ve otel hissi.',
      imageUrl:
      ...
      budget: 'premium',
      budgetLabel: '150K+',
      colors: ['Mermer', 'Kum tasi', 'Koyu bronz'],
    ...
    _DiscoveryCard(
      id: 'japandi_bathroom',
      title: 'Spa Hissi',
      subtitle: 'Dogalligi yuksek, sakin ve yavas bir banyo dili.',
      imageUrl:
    ...
    _DiscoveryCard(
      id: 'modern_bedroom',
      title: 'Aksam Modu',
      subtitle: 'Daha dramatik tonlar ve otel benzeri sadelik.',
      imageUrl:
          'https://images.unsplash.com/photo-1618219908412-a29a1bb7b86e?auto=format&fit=crop&w=900&q=85',
      style: 'modern',
      styleLabel: 'Modern',
      room: 'yatak_odasi',
      roomLabel: 'Yatak Odasi',
      budget: 'high',
      budgetLabel: '70-150K',
      colors: ['Koyu tas', 'Buz grisi', 'Siyah'],
