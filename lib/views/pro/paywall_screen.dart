...
class _PaywallScreenState extends State<PaywallScreen> {
  ...
  Widget _buildTitleAndBullets() {
    const bullets = [
      'Sınırsız Koala AI tasarım danışmanlığı',
      'Fotoğrafından AI ile sınırsız mekan dönüşümü',
      'Evlumba profesyonellerinden anında cevap',
      'Akıllı tarz keşfi — sınırsız swipe, sana özel öneri',
    ];
    return Column(
