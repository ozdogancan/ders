...
// ═══════════════════════════════════════════════════════
class _ActiveConversationsRow extends StatefulWidget {
  const _ActiveConversationsRow();

  @override
  State<_ActiveConversationsRow> createState() =>
      _ActiveConversationsRowState();
}

class _ActiveConversationsRowState extends State<_ActiveConversationsRow> {
  ...
  @override
  Widget build(BuildContext context) {
    if (!_loaded || _convs.isEmpty) return const SizedBox.shrink();
