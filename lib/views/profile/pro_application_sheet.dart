...
class _ProApplicationSheetState extends ConsumerState<ProApplicationSheet>
  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 22),
        // 2026-06-02: "Konumumdan çek" pill KALDIRILDI (kullanıcı isteği).
        // Sadece 81 il seçici kaldı.
        _CityPickerField(
          controller: _city,
  ...
  // 2026-06-02: konumdan il çekme (navigator.geolocation + BigDataCloud
  // reverse-geocode) ve _normalizeTr KALDIRILDI — "Konumumdan çek" pill'i
  // kaldırıldığı için artık kullanılmıyordu.
...
// 2026-06-02: "Konumumdan çek" pill (_LocationPill) KALDIRILDI.
// ═══════════════════════════════════════════════════════════════════════
